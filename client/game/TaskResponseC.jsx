    ...
    return (
      <div className="task-response">
        ...
        <div className="task-response-form">
          <div>
            <p>Once upon a time a programmer wanted to write a function to compare two strings lexicographically 
              ignoring the letter’s case (whether it was uppercase or lowercase) so that it printed -1 if the first 
              string was less, “1” if the second was less than the first one, and “equal” if the strings are equal. 
              Help her by modifying the code below to achieve this functionality.</p>
          </div>
          <div className="selected-draft">
            <p>
            <a href='https://pastebin.com/YHPKzCML'>Open This Link in a New Tab to View Code</a>
            </p>
          </div>
        </div>
